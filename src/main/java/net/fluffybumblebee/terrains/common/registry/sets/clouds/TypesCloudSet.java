package net.fluffybumblebee.terrains.common.registry.sets.clouds;

import net.fluffybumblebee.terrains.common.instances.block.cloud.*;
import net.fluffybumblebee.terrains.common.registry.sets.clouds.component.CloudSet;
import net.minecraft.particle.DustParticleEffect;
import net.minecraft.util.math.Vec3f;

import static net.fluffybumblebee.terrains.common.registry.sets.clouds.component.CloudSet.aercloud;
...
public class TypesCloudSet {
    ...
    public static final CloudSet.Config[] ALL = {
            ...
            IRRADIATED = of(new RedstoneCloudBlock(aercloud()), 0.008F, "irradiated"),
    ...
    private static CloudSet.Config of(final BasicCloudBlock cloudBlock, final float probability, final String id) {
        return new CloudSet.Config(cloudBlock, probability, id);
    }
}
