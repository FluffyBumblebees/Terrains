...
public final class BasicTreeSetConfig<E extends Enum<?>> implements FeatureRegistrar<BlockSet<?>> {
    ...
    public BasicTreeSetConfig(E type, TreeFoliageSetConfig<E, StainedSaplingGenerator> foliage) {
