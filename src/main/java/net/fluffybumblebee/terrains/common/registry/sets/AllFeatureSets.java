...
public final class AllFeatureSets {
    public static final FeatureSet<StainedTreeTypes, StainedTreeSetConfig<StainedTreeTypes>> STAINED_TREES;
    ...
    static {
        STAINED_TREES = new FeatureSet<>(StainedTreeTypes.values(), StainedTreeSetConfig::new);
    ...
    public static BasicIterator<BasicIterator<BlockSet<?>>> getIterator() {
        return ITERATOR;
    }
