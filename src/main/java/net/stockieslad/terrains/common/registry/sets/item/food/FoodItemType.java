package net.stockieslad.terrains.common.registry.sets.item.food;

import net.stockieslad.terrains.common.instances.item.food.FoodItem;
...
import static net.stockieslad.terrains.common.registry.sets.item.component.ItemSet.getItem;
