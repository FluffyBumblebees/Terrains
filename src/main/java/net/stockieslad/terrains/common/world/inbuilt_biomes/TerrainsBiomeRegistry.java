...
import net.stockieslad.terrains.common.world.inbuilt_biomes.component.*;
import net.minecraft.util.registry.RegistryKey;
import net.minecraft.world.biome.Biome;

import static net.stockieslad.terrains.util.registration.world.biome.BiomeRegistryTools.add;
